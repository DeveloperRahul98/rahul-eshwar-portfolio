    ...
    <SectionWrapper id="skills">
      <div className="text-center mb-12">
        <h2 className="text-2xl sm:text-4xl font-bold font-mono">
          ...
          <TextReveal className="gradient-text">Skills</TextReveal>
          <span className="text-cyan align-middle mx-1">/&gt;</span>
        </h2>
      </div>
                ...
                {categorySkills.map((skill, i) => {
                  ...
                  return (
                    <motion.div
                      ...
                      whileHover={{ y: -4 }}
                    >
                      <SpotlightCard className="glass-card rounded-xl p-4 flex flex-col items-center gap-2.5 neon-border-hover transition-all duration-300 cursor-default group h-full">
